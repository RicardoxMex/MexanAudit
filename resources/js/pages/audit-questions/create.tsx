...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nueva Pregunta', href: '/audit-questions/create' },
];
...
export default function QuestionsCreate({ sections, section_id }: QuestionsCreateProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        order: '0',
        options: [] as Array<{ label: string; value: string; order: number }>,
    });

    const addOption = () => {
        setData('options', [...data.options, { label: '', value: '', order: data.options.length }]);
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Nueva Pregunta</h1>
                    <p className="text-muted-foreground mt-2">
                        Crea una nueva pregunta para las auditorías
                    </p>
                </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Completa los datos de la pregunta
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
